...
public class ResourceAssignment {
	...
	public static void main(String argv[]) {
		...
		if (argv.length != 2) {
			...
			System.out.print("project file: ");
			argv = new String[2];
			argv[0] = sca.nextLine();
			System.out.print("resource file: ");
			argv[1] = sca.nextLine();
		}
		...
		/*
		 * The following instantiations create a list of projects and resources.
		 * The pathname for the file containing course information is passed to
		 * the main program on the command line as the first argument (argv[0]).
		 * The pathname for the file containing resource information is passed
		 * to the main program on the command line as the second argument
		 * (argv[1]). An example resources file and projects file is provided as
		 * resources.txt and projects.txt
		 */
